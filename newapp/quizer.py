...
bot = Bot(token="1619381009:AAEAlXyTON2xG6H-m2OaCAq96i63bdZyRpA")
dp = Dispatcher(bot)
...
async def msg_with_poll(message: types.Message):
    ...
    await bot.send_message(test_group, "here")
...
async def my_poll(message: types.Message):
    ...
    await message.bot.send_poll(test_group, question='my question', options=['qqq', 'www'], allows_multiple_answers=True)
